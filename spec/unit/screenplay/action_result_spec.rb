require 'screenplay/action_result'


describe Screenplay::ActionResult do
  let(:result) do
  ...
  describe '#initialize' do
    context 'ssh_output is a Net::SSH::Simple::Error' do
      subject do
        Screenplay::ActionResult.new(error)
      end
      ...
      context 'with status param' do
        subject { Screenplay::ActionResult.new(error, :test) }
    ...
    context 'ssh_output is a Net::SSH::Simple::Result' do
      subject { Screenplay::ActionResult.new(result) }
      ...
      context 'with status param' do
        subject { Screenplay::ActionResult.new(result, :test) }
  ...
  describe '#exception?' do
    context 'an exception was passed in' do
      subject { Screenplay::ActionResult.new(error) }
