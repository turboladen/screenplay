...
Vagrant::Config.run do |config|
  ...
  config.vm.define :debian_wheezy_64 do |os|
    os.vm.host_name = 'debian-wheezy-64'
    os.vm.box = 'debian-wheezy-64'
    os.vm.box_url = 'https://github.com/downloads/leapcode/minimal-debian-vagrant/wheezy.box'
    os.vm.network :hostonly, '192.168.33.103'
    # config.vm.provision :screenplay, &provision
  end
